...
//vec2 size_of_image = textureSize(main_texture, 0);
//
in VS_OUT
{
	vec2 texcoord;
...
COMPAT_PRECISION vec2 OutputSize = textureSize(Texture, 0);
COMPAT_PRECISION vec2 TextureSize = textureSize(Texture, 0);
COMPAT_PRECISION vec2 InputSize = textureSize(Texture, 0);


// compatibility #defines
#define Source Texture
#define vTexCoord fs_in.texcoord
